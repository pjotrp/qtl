...
void R_scanMQM(int *Nind,int *Nmark,int *Npheno,
			   ...
			   double *stepmi,double *stepma,int *NRun, double *qtl,int re_estimate,int *crosstype);
...
void scanMQM(int Nind, int Nmark,int Npheno,int **Geno,int **Chromo, 
			 ...
			 double Windowsize,double Steps,
			 double Stepmi,double Stepma,int NRUN, double **QTL,int *reestimate,int *crosstype);
